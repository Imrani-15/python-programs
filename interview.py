# you are given a string S of size N. You need to fine the number of subsequences of
# string S that can be made palindrome by rearrainging. Since the andert vsn br large
