...
class CountDown:
    def __init__(self, root):
        ...
        self.root.configure(bg='gray35')
        # Fixing the Window length constant
        self.root.resizable(width=False, height=False)

        # Tkinter Label
        time_label = Label(self.root, text="Set Time",
        ...
        second_label = Label(self.root, text="Second",
                             font=("times new roman", 15), bg='gray35', fg='white')
        ...
        # Tkinter Combobox
        self.hour = StringVar()
        self.hour_combobox = ttk.Combobox(self.root, width=8,
        ...
        self.minute_combobox = ttk.Combobox(self.root, width=8,
        ...
        self.second_combobox = ttk.Combobox(self.root, width=8,
        ...
        # Tkinter Button
        # calcel button
        cancel_button = Button(self.root, text='Cancel',
                               font=('Helvetica', 12), bg="white", fg="black",
                               command=self.Cancel)
        cancel_button.place(x=140, y=150)

        # Done Button
        done_button = Button(self.root, text='Done',
                             font=('Helvetica', 12), bg="green", fg="white",
                             command=self.Threding)
    ...
    def show_time(self):
        ...
        try:
            ...
            process = multiprocessing.Process(target=playsound,
                                              args=('C:\\Users\\HOME\\PycharmProjects\\tone.mp3',))
            process.start()
